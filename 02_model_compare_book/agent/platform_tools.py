...
from .config import ASSISTANT_API_BASE, HTTP_TIMEOUT, PLATFORM_API_BASE
...
@log_tool("fetch_prediction_logs")
...
@log_tool("fetch_equipment_history")
...
@log_tool("search_process_recipes")
...
@log_tool("fetch_generator_status")
...
@log_tool("list_platform_reports")
...
@log_tool("create_platform_report")
