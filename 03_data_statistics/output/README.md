...
| `gemma4:26b` | failed | 0.0% | 0 | 0 | 5.7s | `gemma4_26b/` |
| `qwen3.6:35b` | failed | 0.0% | 0 | 0 | 4.9s | `qwen3_6_35b/` |
| `qwen3-vl:32b` | failed | 0.0% | 0 | 0 | 4.8s | `qwen3_vl_32b/` |
